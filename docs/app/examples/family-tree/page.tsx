      ...
      defineColumns<FamilyMember>([
        {
          ...
          meta: {
            bonelessTable: { sizing: { minPx: 260, flex: 1.6 }, filtering: { type: 'text' } },
          },
        },
        {
          key: 'relationship',
          ...
          meta: {
            bonelessTable: {
              ...
              filtering: {
                type: 'select',
                options: ['Root', 'Child', 'Grandchild', 'Great-grandchild', 'Descendant'],
              },
            },
          },
        },
        ...
        <div className="mb-5 flex items-end justify-between gap-4 max-sm:items-start">
          <div>
            ...
            <p className="mt-1 text-slate-500">
              ...
              individual branch or control the whole tree from one toolbar action, then filter or
              sort without losing column alignment.
            </p>
            <ExampleSettings
              items={[
                ...
                { name: 'tree.columnId', description: 'puts indentation in the name cell' },
                {
                  ...
                  description: 'preserves parents of matching descendants',
                },
