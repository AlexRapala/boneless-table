...
const columns = defineColumns<Account>([
  { key: 'account', header: 'Account', meta: { bonelessTable: { sizing: { minPx: 160, flex: 1 } } } },
  { key: 'plan', header: 'Plan', meta: { bonelessTable: { sizing: { minPx: 160, flex: 1 } } } },
...
export function AccountsTable({ data }: { data: Account[] }) {
  return <BonelessTable data={data} columns={columns} resultLabel="accounts" />
}`
    ...
    <AdminPage title="Table layout">
      <section>
        ...
        <p className="mt-1 max-w-3xl text-slate-500">
          ...
          the column menu use the renderer defaults.
        </p>
        <ExampleSettings
          items={[
